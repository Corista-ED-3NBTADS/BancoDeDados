...
-- Cria o banco de dados 'coro' se ele ainda não existir.
CREATE DATABASE IF NOT EXISTS coristas;

-- Seleciona o banco 'coro' para usar nos comandos seguintes.
USE coristas;
...
-- Relacionamento N:N entre coristas e eventos para marcar presença
...
-- Relacionamento N:N entre músicos e eventos para marcar presença
...
-- BÔNUS: Já insere as vozes para você poder testar o programa imediatamente!
INSERT INTO vozes (tipo_voz) VALUES ('Soprano'), ('Contralto'), ('Tenor'), ('Baixo');